...
<div class="goods">
<h3 class="ui header" style="color: red; text-align: center;">g o o d s &nbsp;&nbsp;&nbsp;e d i t</h3><br>
	<form:form class="ui form" commandName="goodsVO" method="POST" enctype="multipart/form-data">
		<table class="ui table" border="1">
			...
			<tr>
				...
				<td>
					상품설명 이미지 수정시 전부 규칙에 맞춰 재업로드<br>
					<input type="file" name="descriptFile" multiple="multiple" accept="image/*"><br>
					${goodsVO.descript}
				</td>
			</tr>
		</table>
		<div style="float: right;">
			<input class="small ui red button" type="submit" value="수정">
