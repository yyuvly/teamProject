...
<div class="goods">
<form name="deleteForm" action="<c:url value="/goods/delete"/>" method="post" style="text-align: center;">
	<h3 class="ui header" style="color: red; text-align: center;">g o o d s &nbsp;&nbsp;&nbsp;d e l e t e</h3><br>
	...
	<a class="small ui yellow button" href="<c:url value="/goods/read/${num}"/>">취소</a>
	</form>
	<div>${msg}</div>
</body>
</html>
