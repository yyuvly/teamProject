...
<div class="review">
<h3 class="ui header" style="color: red; text-align: center;">r e v i e w &nbsp;&nbsp;&nbsp;l i s t<br>- h o t e l -</h3><br>
<a class="small ui yellow button" href="<c:url value="/review/list"/>" >all</a>
<a class="small ui red button" href="<c:url value="/review/hotel"/>" >hotel</a>
<a class="small ui yellow button" href="<c:url value="/review/goods"/>" >goods</a><br>
	...
	<c:if test="${hotelpagemaker.prev}">
		<a href="${path}/review/hotel?pageNum=${hotelpagemaker.start-1}">prev</a>
	</c:if>
	<c:forEach begin="${hotelpagemaker.start}" end="${hotelpagemaker.end}" var="nm">
		<a href="${path}/review/hotel?pageNum=${nm}">[ ${nm} ]</a>
	</c:forEach>
	<c:if test="${hotelpagemaker.next}">
		<a href="${path}/review/hotel?pageNum=${hotelpagemaker.end+1}">next</a>
	</c:if>
	</div>
